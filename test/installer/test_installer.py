...
def installer_path():
    path = "DeadlineCloudForKeyShotSubmitter-{platform}-installer.{ext}"
...
def test_default_location(installer_path: Path):
    ...
    --prefix <prefix>                           Installation Directory
                                                Default: /home/<user>/DeadlineCloudForKeyShotSubmitter
    """
    # GIVEN
    default_install_location = Path("~/DeadlineCloudForKeyShotSubmitter").expanduser()
