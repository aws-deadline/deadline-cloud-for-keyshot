...
def test_keyshot_client_has_render_options_action():
    with mock.patch.object(lux, "pause"):
        client = KeyShotClient("127.0.0.1")
        assert "render_options" in client.actions
